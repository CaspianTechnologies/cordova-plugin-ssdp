...
namespace SSDP
{
    ...
    {
        public static IPAddress ClassA { get; } = IPAddress.Parse("255.0.0.0");
        public static IPAddress ClassB { get; } = IPAddress.Parse("255.255.0.0");
        public static IPAddress ClassC { get; } = IPAddress.Parse("255.255.255.0");
